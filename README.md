...
1. Creazione programma in C che, dato un numero D reale immesso da tastiera, calcola: 
  a) l'area di un quadrato di lato D;
  b) l'area di un cerchio di diametro D;
  c) l'area di un triangolo equilatero di lato D

2. Creazione programma in C che, dati 3 numeri (interi o decimali) immessi da tastiera, calcola la media aritmetica dei numeri e stampa il risultato con due cifre decimali e arrotondato.
   
3. Creazione programma in C che, dato un numero D intero o decimale immesso da tastiera, calcola: 
